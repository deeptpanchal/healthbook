<%-- 
    Document   : Healthbook
    Created on : Apr 4, 2018, 9:05:52 PM
    Author     : deept
--%>
...
<html>
    ...
    <center>
        <font face="vardana" color="blue" size="50px">Health bOOk</font><br>
        ...
        <tr>
            ...
            <%
                try {
                    ...
                    while (pr.next()) 
                    {
                        if(aadhaarnumber.equals(pr.getString(2))==true)
                        {
                            out.println("<tr>");
                                out.println("<td>"+pr.getString(1)+"</td>");
                                out.println("<td>"+pr.getString(15)+"</td>");
                                out.println("<td>"+pr.getString(3)+"</td>");
                                
                                Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/mci","root","");
                                Statement st1 = conn.createStatement();
                                ResultSet pr1 = st1.executeQuery("select * from mcidetails");
                                while(pr1.next())
                                {
                                    if(pr1.getString(1).equals(pr.getString(3)))
                                    {
                                        out.println("<td>"+pr1.getString(2)+"</td>");
                                        out.println("<td>"+pr1.getString(3)+"</td>");
                                        break;
                                    }
                                }
