<%-- 
    Document   : Login
    Created on : Apr 5, 2018, 8:58:50 AM
    Author     : deept
--%>
...
<body> 
    ...
    <center>
      <div>
     <form action="login_doctor_servlet">
        <input type="text" name="MCI" placeholder="MCI Number" required=""><br>
        <input type="text" name="password" placeholder="Password" required=""> <br> 
        <a href="http://localhost:8080/Login_doctor/createforgotpassword.jsp">create password / Forgot your password?</a>
        <br>
        <input type="submit" value="submit">
    </form>
    <hr width="300px" color="#0066cc">
    <form action="login_doctor_servlet" method="post">
        <input type="text" name="MCI" placeholder="MCI Number" required=""><br>
